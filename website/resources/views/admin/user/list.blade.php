                    ...
                    <table class="table table-striped table-checkall">
                        ...
                        @if ($users->total() > 0)
                            ...
                            <tr>
                                ...
                                @if (Auth::id() != $user->id)
                                        <a href="{{route('delete-user', $user->id)}}" onclick="return confirm('Bạn có chắc xóa thành viên này không')" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                @endif
                                </td>
                            </tr>
                            @endforeach
